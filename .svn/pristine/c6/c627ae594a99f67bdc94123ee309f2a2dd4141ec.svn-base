...
namespace Metro_Rail_DAL.DAL.Payroll.Transaction
{
    public class T19021DAL : CommonDAL
    {
        ...
        public DataTable GetSalarySummeryMonthWise(int fromDate, int toDate)
        {
            DataTable dt = new DataTable();
            dt = Query($@"select t20.T_SALARY_CODE, t20.T_VERIFY_FLAG, t20.T_MONTH_CODE, (select dbo.T11011.T_MONTH_NAME from dbo.T11011 where T11011.T_MONTH_CODE = t20.T_MONTH_CODE) MONTH_NAME, t20.T_YEAR, t21.T_EMP_CODE, t11.T_EMP_NAME EMP_NAME, t11.T_GRADE_CODE, (select t08.T_GRADE_NAME from dbo.T19008 t08 where t08.T_GRADE_CODE = t11.T_GRADE_CODE) GRADE_NAME, t21.T_SALARY_PAYMENT, t21.T_SALARY_DEDUCTION, t21.T_SALARY_PAYABLE from dbo.T19020 t20 join dbo.T19021 t21 on t20.T_SALARY_CODE = t21.T_SALARY_CODE join dbo.T11111 t11 on t21.T_EMP_CODE = t11.T_EMP_CODE where t20.T_YEAR = '2025' AND CAST(t20.T_MONTH_CODE AS INT) BETWEEN {fromDate} AND {toDate}");
            return dt;
        }
    }
}
