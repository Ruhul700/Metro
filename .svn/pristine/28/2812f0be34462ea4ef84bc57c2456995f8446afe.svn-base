...
{
    public class T13004Controller : Controller
    {
        T13004DAL repository = new T13004DAL();
        // GET: AT13004        
        [HttpPost]
        ...
        public ActionResult ReportVoucherList(string center, string fromDate, string toDate)
        {
            var details = repository.GetReportVoucherList(center, fromDate, toDate);
            // var dueTotal = repository.GetDueTotal(fdate, tdate);
            ReportViewer rv = new ReportViewer();
            rv.LocalReport.ReportPath = "Reports/RDLC/VoucherList.rdlc";
            ...
            rddetails.Name = "VoucherList";//This refers to the dataset name in the RDLC file
        ...
        public ActionResult ReportVoucherSingle(string voucherNo)
        {
            var details = repository.ReportVoucherSingle(voucherNo);
            // var dueTotal = repository.GetDueTotal(fdate, tdate);
            ReportViewer rv = new ReportViewer();
            rv.LocalReport.ReportPath = "Reports/RDLC/VoucherSingle.rdlc";
            rv.LocalReport.EnableExternalImages = true;
            // for setting parameter 
            List<ReportParameter> param1 = new List<ReportParameter>();
            param1.Add(new ReportParameter("fdate", "01-01-2021"));


            ReportDataSource rddetails = new ReportDataSource();
            rddetails.Name = "VoucherSingle";//This refers to the dataset name in the RDLC file
            rddetails.Value = details;
