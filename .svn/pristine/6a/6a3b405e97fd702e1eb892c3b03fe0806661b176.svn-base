...
{
    public class T12020Controller : Controller
    {
        // GET: T12020
        T12020DAL repository = new T12020DAL();
        [HttpPost]
        public ActionResult GetAllPeriodData()
        {
            try
            {
                var data = repository.GetAllPeriodData();
        ...
        [HttpPost]
        public ActionResult SaveData(T12020Data model)
        {
            try
            {
